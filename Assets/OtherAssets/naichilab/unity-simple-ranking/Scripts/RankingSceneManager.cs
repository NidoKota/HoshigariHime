        ...
        private IEnumerator LoadRankingBoard()
        {
            ...
            else if (so.Count > 0)
            {
                ...
                foreach (var r in so.Result)
                {
                    ...
                    rankNode.NoText = rankNode.transform.Find("No").GetComponent<Text>();
                    rankNode.NameText = rankNode.transform.Find("Name").GetComponent<Text>();
                    rankNode.ScoreText = rankNode.transform.Find("Score").GetComponent<Text>();
