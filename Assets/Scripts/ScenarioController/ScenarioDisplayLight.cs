...
namespace ScenarioController
{
    ...
    public class ScenarioDisplayLight : ScenarioDisplayBase
    {
        ...
        ScenarioTMPAnimationData nowAnimationData;                    //現在のScenarioのAnimationData
            ...
            if (State == ScenarioDisplayState.Work)
            {
                ...
                if (nowAnimationData)
                {
                    ...
                    for (int i = 0; i <= characterIndex; i++)
                    {
                        ...
                        if (nowAnimationData.usePositionYAnimation || nowAnimationData.useRotationZAnimation || nowAnimationData.useScaleAllAnimation) tmp.UpdateVertexData(TMP_VertexDataUpdateFlags.Vertices);
        ...
        void SetNextScenario()
        {
            ...
            nowAnimationData = nowScenario.animationData;
        ...
        void SetTMPAnimation(int index, float time)
        {
            ...
            if (nowAnimationData.usePositionYAnimation || nowAnimationData.useRotationZAnimation || nowAnimationData.useScaleAllAnimation)
            {
                float animPosY = 0;
                float animRotZ = 0;
                ...
                Matrix4x4 matrix = Matrix4x4.TRS(nowAnimationData.addPosition + Vector3.up * animPosY, Quaternion.Euler(nowAnimationData.addRotation) * Quaternion.Euler(0, 0, animRotZ), nowAnimationData.addScale + Vector3.one * animScaleAll);
